...
import com.example.demo.model.EstimationCharge;
import com.example.demo.model.PlanningAction;
import jakarta.validation.constraints.NotBlank;
import java.time.LocalDate;
import java.util.List;

public class FicheProjetRequest {
    @NotBlank
    ...
    private String cadreContractuelProjet;
    private String caractereProjet;
    ...
    private String modaliteDeveloppement;
